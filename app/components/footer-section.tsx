        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              ...
              <a href="/core" className="block transition-colors hover:text-primary">
                Core
              </a>
              <a href="/heads" className="block transition-colors hover:text-primary">
                Heads
              </a>
            </nav>
          </div>
